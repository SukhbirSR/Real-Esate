...
<html>
<head>
	<title>MGM Properties | Search</title>
...
<body>
    ...
    if (isset($_POST['s1'])) {
		...
		$area=$_POST['area'];
	    $sql1="select * from property where city='$city' or description='$prop' or value='$price' or available='$available' or  size='$area'";
...
<?php 
	...
	echo "<div class='show0'>No record found!</div>";
}
}
?>
<footer>
